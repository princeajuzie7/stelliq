...
const features = [
  {
    number: "01",
    title: "Global Payout Infrastructure",
    description: "Send cross-border payments instantly using Stellar-powered rails. Eliminate delays and high fees associated with traditional international transfers.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Developer-First APIs",
    description: "Integrate global payment capabilities directly into your applications. Stelliq provides simple, powerful APIs designed for developers building modern financial products.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Real-Time Financial Operations",
    description: "Monitor balances, track payouts, and manage global transactions through a unified cloud dashboard built for modern financial teams.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Enterprise Security",
    description: "Built with secure infrastructure, encrypted transactions, and strict access control to ensure financial data remains protected at every layer.",
    visual: "security",
  },
];
